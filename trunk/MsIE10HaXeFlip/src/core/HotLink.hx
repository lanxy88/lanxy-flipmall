		...
		switch(type)
		{
			...
			case "image":
				...
				*/
				...
				{
					Lib.document.getElementById("cvsOthers").innerHTML = txt;	
					//Lib.document.getElementById("popupImage").style.cssText += "transform: scale(1);transition: width 0.5s ease-out; -ms-transform: scale(1);-ms-transition: width 0.5s ease-out;  -webkit-transform: scale(1); -webkit-transition: 0.5s ease-out; " ;

		...
		switch(type)
		{
			...
			case "image":
				...
				*/
				...
				{
					Lib.document.getElementById("cvsOthers").innerHTML = txt;	
					Lib.document.getElementById("popupImage").style.cssText += "-moz-transform: scale(1);-moz-transition: width 0.5s ease-out;  -webkit-transform: scale(1); -webkit-transition: 0.5s ease-out; " ;
				});
				RunTime.logClickLink(destination);
			case "video":
				/*
				...
				*/
				...
				RunTime.setOffset(Lib.document.getElementById("cvsOthers"), popupXOffset, popupYOffset);
				Lib.document.getElementById("cvsOthers").innerHTML = HtmlHelper.toPopupVideoHtml(this);
				Lib.document.getElementById("popupVideo").style.cssText += "-moz-transform: scale(1);-moz-transition: width 0.5s ease-out; -webkit-transform: scale(1); -webkit-transition: 0.5s ease-out; " ;

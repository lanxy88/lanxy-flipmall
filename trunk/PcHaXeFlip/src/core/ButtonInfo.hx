		...
		switch(type)
		{
			...
			case "image":
				...
				HtmlHelper.toPopupImageHtml(this, function(txt:String):Void
				{
					...
					Lib.document.getElementById("popupImage").style.cssText += " -moz-transform: scale(1);-moz-transition:width  2s ease-out;-webkit-transform: scale(1); -webkit-transition: 0.5s ease-out; " ;
				});
				RunTime.logClickLink(destination);
			case "video":
				RunTime.showPopupMaskLayer();
				...
				Lib.document.getElementById("popupVideo").style.cssText += " -moz-transform: scale(1);-moz-transition:width  2s ease-out; -webkit-transform: scale(1);-webkit-transition: 0.5s ease-out; " ;
			...
			case "message":
				...
				Lib.document.getElementById("popupMessage").style.cssText += " -moz-transform: scale(1);-moz-transition:width  2s ease-out; -webkit-transform: scale(1);-webkit-transition: 0.5s ease-out; " ;
			case "message-hover":
				RunTime.showPopupMaskLayer();
				RunTime.setOffset(Lib.document.getElementById("cvsOthers"), popupXOffset, popupYOffset);
				Lib.document.getElementById("cvsOthers").innerHTML = HtmlHelper.toPopupHtml(this);

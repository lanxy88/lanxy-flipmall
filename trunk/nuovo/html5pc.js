...
FlipBook.prototype = {
	...
	,removeBookmark: function(pageNum) {
		...
		while(_g1 < _g) {
			var i1 = _g1++;
			haxe.Log.trace(RunTime.book.bookmarks[i1].pageNum,{ fileName : "FlipBook.hx", lineNumber : 1969, className : "FlipBook", methodName : "removeBookmark"});
	...
	,onMouseDown: function(e) {
		if(js.Lib.window.navigator.userAgent.indexOf("Firefox") != -1) return;
		e.stopPropagation();

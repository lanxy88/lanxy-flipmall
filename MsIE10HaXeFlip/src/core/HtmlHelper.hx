...
class HtmlHelper 
{
	...
	public static function toPopupImageHtml(item:Dynamic, success:String->Void):Void
	{
		...
		*/
		...
		if (item.popupWidth != null && item.popupHeight != null)
		{
			...
			+ Std.string(h) + "px; background-color:#ffffff;transform: scale(0.2);transition: 0ms; -ms-transform: scale(0.2);-ms-transition: 0ms;\">";
	...
	public static function toPopupVideoHtml(item:Dynamic):String
	{
		...
		+ Std.string(top) + "px; width:"
		+ Std.string(w) + "px; height:"
		+ Std.string(h) + "px; background-color:#ffffff;transform: scale(0.2);transition: 1s ease-out;-ms-transform: scale(0.2);-ms-transition: 1s ease-out; -webkit-transform: scale(0.2); -webkit-transition: 1s ease-out; \">";
	...
	public static function toPopupPageAudiosHtml(audio:AudioInfo, isLeft:Bool = true):String
	{
		...
		if (isLeft == true)
		{
			s += "<div style=\"position:absolute; z-index:202;left:"
			+ Std.string(left) + "px; top:" 
			+ Std.string(top) + "px; width:"
			+ Std.string(w) + "px; height:"
			+ Std.string(h) + "px; \">";
